...
Willkommen im vollständigen Benutzerhandbuch für **MGD AI Kennzeichnung**.

Das Plugin hilft Ihnen, lokale Shopbilder strukturiert zu prüfen und transparent als KI-generiert, teilweise KI-generiert, KI-bearbeitet oder Deepfake zu kennzeichnen. Die Originalbilder bleiben unverändert und werden nicht an externe KI-Dienste übertragen.

## Was Sie mit dem Plugin erreichen
...
- Sie behalten Daten und Entscheidungen in Ihrer eigenen Shop-Datenbank.

## Was das Plugin bewusst nicht macht

- keine automatische KI-Erkennung;
- kein Versand von Bildern an einen Analyse- oder Cloud-Dienst;
- keine Veränderung der Originaldatei;
- keine automatische Veröffentlichung von OPC-Seiten;
- keine rechtliche Bewertung Ihres konkreten Inhalts;
...
**Version 1.3.9** enthält den rekursiven Scan aller
unterstützten OPC-Uploads einschließlich Unterordnern und unbenutzter Dateien.
Neu ist eine separate zweifach vergrößerte Detail-Lupe unter dem neutralen
Schuhbild. Bunte Flächen und feine Linien machen Transparenz und Unschärfe
besser erkennbar. Der Speicher-Hotfix bleibt enthalten. Der Installationsstand
ist gesondert zu prüfen.
Die bisherigen Filter und Kennzeichnungen bleiben erhalten.

Version 1.3.9 enthält weiterhin die zwei großen Sprachkarten und den
...
Veröffentlichte Installationspakete finden Sie unter [Releases](https://github.com/MichaelGahnDESIGN/MGD-AI-Kennzeichnung-JTL-Shop-5/releases). Verwenden Sie das angehängte Paket `MGD_AI_Kennzeichnung-1.3.9.zip`. Prüfen Sie jeweils den mitgelieferten SHA-256-Wert. Das öffentliche Repository stellt Hinweise bereit, aber keinen Auto-Updater; das Update erfolgt als manueller ZIP-Upload im JTL-Plugin-Manager.
