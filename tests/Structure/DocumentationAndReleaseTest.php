...
final class DocumentationAndReleaseTest extends TestCase
{
    ...
    private const ZIP = self::ROOT . '/dist/MGD_AI_Kennzeichnung-1.3.3.zip';
    ...
    public function releaseziel_und_lokale_artefakte_sind_eindeutig_abgegrenzt(): void
    {
        ...
        self::assertStringContainsString('MGD_AI_Kennzeichnung-1.3.3.zip', $script);
        self::assertStringNotContainsString('MGD_AI_Kennzeichnung-1.2.1.zip', $script);
        self::assertStringContainsString('<Version>1.3.3</Version>', $infoXml);
        self::assertStringContainsString('MGD-AI-Kennzeichnung-JTL-Shop-5/1.3.3', $checker);
        self::assertStringContainsString("check(true, '1.3.3')", $display);
...
BASH;
    ...
    #[Test]
    public function version_1_3_3_ist_in_paket_ci_und_benutzerdokumentation_konsistent(): void
    {
        $dateien = [
            'README' => self::ROOT . '/README.md',
            ...
            'Release' => self::ROOT . '/Dokumentation/Release-1.3.3.md',
