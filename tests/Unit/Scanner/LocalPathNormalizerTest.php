...
final class LocalPathNormalizerTest extends TestCase
{
    ...
    public static function unsichereReferenzen(): iterable
    {
        ...
        yield 'kodierte externe URL' => ['https%3A%2F%2Fevil.example%2Fa.jpg'];
        yield 'doppelt kodierte externe URL' => ['https%253A%252F%252Fevil.example%252Fa.jpg'];
        yield 'kodierte protocol-relative URL' => ['%2F%2Fevil.example%2Fa.jpg'];
        yield 'kodiertes data-Schema' => ['data%3Aimage.jpg'];
        yield 'doppelt kodiertes data-Schema' => ['data%253Aimage.jpg'];
        yield 'kodiertes JavaScript-Schema' => ['javascript%3Aalert.jpg'];
        yield 'doppelt kodiertes JavaScript-Schema' => ['javascript%253Aalert.jpg'];
        yield 'kodiertes file-Schema' => ['file%3A%2F%2F%2Fetc%2Fbild.jpg'];
        yield 'kodiertes php-Schema' => ['php%3A%2F%2Ffilter%2Fbild.jpg'];
        yield 'doppelt kodiertes ftp-Schema' => ['ftp%253A%252F%252Fevil.example%252Fa.jpg'];
        yield 'kodierter Windows-Pfad' => ['C%3A%5Cbilder%5Ca.jpg'];
        yield 'kodierter UNC-Pfad' => ['%5C%5Cserver%5Cfreigabe%5Ca.jpg'];
        yield 'kodierte Query' => ['a.jpg%3Ftoken.jpg'];
        yield 'doppelt kodierte Query' => ['a.jpg%253Ftoken.jpg'];
        yield 'kodiertes Fragment' => ['a.jpg%23fragment.jpg'];
        yield 'doppelt kodiertes Fragment' => ['a.jpg%2523fragment.jpg'];
        yield 'kodiertes NUL' => ['bilder/a.jpg%00.png'];
        yield 'kaputtes URL-Schema' => ['https:/evil.example/a.jpg'];
