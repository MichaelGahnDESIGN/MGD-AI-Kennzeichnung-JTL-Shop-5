...
Requirements: JTL-Shop 5.7.2 or newer, PHP 8.1 or newer, and NOVA or a compatible NOVA child theme. Back up the database and plugin files before installation. The complete German user guide is available in the [GitHub Wiki](https://github.com/MichaelGahnDESIGN/MGD-AI-Kennzeichnung-JTL-Shop-5/wiki); operating, privacy and rollback documents are stored in [`Dokumentation/`](Dokumentation/README.md).
