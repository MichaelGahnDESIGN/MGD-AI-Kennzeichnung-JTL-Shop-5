...
`dist/MGD_AI_Kennzeichnung-1.3.5.zip`. Innerhalb dieser Pfade sind nur die für
...
Repository stellt Releasehinweise bereit. Version 1.3.5 enthält bewusst keinen
...
- Der Dateiname behält die Version, beispielsweise
  `MGD_AI_Kennzeichnung-1.3.5.zip`; eine zugehörige Prüfsummendatei liegt bei Bedarf daneben.
