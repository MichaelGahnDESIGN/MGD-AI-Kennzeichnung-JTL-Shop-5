...
`dist/MGD_AI_Kennzeichnung-1.3.2.zip`. Innerhalb dieser Pfade sind nur die für
...
Repository stellt Releasehinweise bereit. Version 1.3.2 enthält bewusst keinen
