...
`dist/MGD_AI_Kennzeichnung-1.3.4.zip`. Innerhalb dieser Pfade sind nur die für
...
Repository stellt Releasehinweise bereit. Version 1.3.4 enthält bewusst keinen
