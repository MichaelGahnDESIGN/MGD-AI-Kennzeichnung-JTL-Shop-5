...
> **Download:** [Release 1.3.7 mit Installations-ZIP und Prüfsumme](https://github.com/MichaelGahnDESIGN/MGD-AI-Kennzeichnung-JTL-Shop-5/releases/tag/v1.3.7). Die Dev-Abnahme ist abgeschlossen; bestehende Shops müssen separat aktualisiert werden.
...
3. `MGD_AI_Kennzeichnung-1.3.7.zip` zuerst auf der getrennten Dev-Installation hochladen.
...
Version 1.3.7 findet zusätzlich alle
...
`MGD-AI-Kennzeichnung-JTL-Shop-5/1.3.7`. Bilder, Kunden-, Shop- und
...
- [Release 1.3.7](Dokumentation/Release-1.3.7.md)
...
unzip -t dist/MGD_AI_Kennzeichnung-1.3.7.zip
shasum -a 256 dist/MGD_AI_Kennzeichnung-1.3.7.zip
```
