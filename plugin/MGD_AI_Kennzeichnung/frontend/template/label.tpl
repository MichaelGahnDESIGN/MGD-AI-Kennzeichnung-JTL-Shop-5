...
{if $mgdAiLabel.visible}
    <span
        ...
        style="--mgd-ai-font-size:{$mgdAiLabel.fontSize|escape:'html':'UTF-8'}px;--mgd-ai-outer-margin:{$mgdAiLabel.outerMargin|escape:'html':'UTF-8'}px;--mgd-ai-inner-padding:{$mgdAiLabel.innerPadding|escape:'html':'UTF-8'}px;--mgd-ai-border-radius:{$mgdAiLabel.borderRadius|escape:'html':'UTF-8'}px;--mgd-ai-blur:{$mgdAiLabel.blur|escape:'html':'UTF-8'}px;--mgd-ai-background-opacity:{$mgdAiLabel.backgroundOpacity|escape:'html':'UTF-8'}"
